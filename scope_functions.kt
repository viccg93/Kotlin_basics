fun main(){
    ...
    //otra de las funciones scope importantes es apply que te permite acceder
    //a los miembros de una clase aun antes de almacenar en una variable
    //tambien se pued usar lambda trailing
    Quiz().apply {
        printQuiz()
    }
}
...
class Quiz: ProgressPrintable {
    ...
    //las funciones scope permiten referirse a un miembro sin llamarlo explicitamente
    //ademas de que el scope en el que se encuentran es el mismo que el del 
    //objeto al que hacen referencia
    //todas las funciones scope son funciones de primer orden
    //let es una funcion scope
    
    fun printQuiz() {
        question1.let {
            //cuando se utiliza let, se puede llamar al objeto usando it
